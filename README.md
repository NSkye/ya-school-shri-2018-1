...
#### Причины возникновения
Ну это даже не ошибка, потому что подобный функционал в изначальном задании просто не реализован. По умолчанию все кластеры окрашиваются в зеленый цвет и больше никаких операций с ними программа не делает:
```javascript
...
/* ... */
```
### 7.1 Попап: не отображается широта и долгота
#### Причины возникновения
